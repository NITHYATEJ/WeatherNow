...
// // Main App component for the weather application
// export default function App() {
//   // State to store the city name entered by the user, starts empty
//   const [query, setQuery] = useState('Hyderabad')
//   // State to store the fetched weather data
//   const [weather, setWeather] = useState(null)
//   // State to manage loading status during API calls
//   const [loading, setLoading] = useState(false)
//   // State to store error messages, if any
//   const [error, setError] = useState('Please enter a city name')

//   // Effect to fetch weather data when query changes, but only if query is non-empty
//   useEffect(() => {
//     if (query && query.trim() !== '') {
//       fetchWeather(query)
//     } else {
...
//           current_weather: true,
//           timezone: 'auto',
//           daily: 'temperature_2m_max,temperature_2m_min,precipitation_sum,weathercode', // Added weathercode
//           forecast_days: 4,
//         },
//       })
