...
//       {/* 4-day weather forecast */}
//       {daily.time && daily.weathercode && daily.temperature_2m_min && daily.temperature_2m_max && daily.precipitation_sum && (
//         <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
//           {daily.time.slice(0, 4).map((t, i) => (
//             <div key={t} className="bg-slate-700/50 rounded p-2 text-center">
//               <div className="text-white font-semibold">
...
//               </div>
//               <div className="text-gray-400 text-xs">
//                 Precip: {Math.round(daily.precipitation_sum[i] || 0)}mm
//               </div>
//             </div>
//           ))}
//         </div>
